  ...
  <div class="container">
    ...
    <form id="git-clone-form" @submit.prevent="generateCommand">
      <div class="form-row">
        <label title="<repo>">
          Repository
          <input v-model="form.repo" type="text" name="repo" placeholder="<repo>">
    ...
    <details>
      ...
      <label title="--depth <depth>">
        Depth
        <input v-model="form.depth" type="text" name="depth" placeholder="<depth>">
        <span class="help" title="Create a shallow clone of that depth.">?</span>
      </label><br>

      <label title="--shallow-since <time>">
        Shallow Since
        <input v-model="form.shallowSince" type="text" name="shallow-since" placeholder="<time>">
      ...
      <label title="--shallow-submodules">
        ...
        <span class="help" title="Any cloned submodules will be shallow.">?</span>
      </label><br>
...
const getRepoName = () => {
  const url = "https://AAA/BBB/myrepo.git";
...
const generateCommand = () => {
  ...
  command += ` --ref-format=${form.value.refFormat}`;
